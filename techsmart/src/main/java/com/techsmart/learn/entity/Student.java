 ...
 * 
 * @GeneratedValue(strategy = GenerationType.IDENTITY) protected int contactNo;
 * 
 * @Column(name = "full_nm") protected String fullName;
 * 
 * @Column(name = "phone_number") protected String phoneNumber;
 * 
 * @Column(name = "email_address") protected String emailAddress; protected
 * String message;
 * 
 ...
 * 
 * @Override public String toString() { return "Student [contactNo=" + contactNo
